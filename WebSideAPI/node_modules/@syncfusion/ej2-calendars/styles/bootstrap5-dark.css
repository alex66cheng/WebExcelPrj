...
.e-calendar .e-header .e-title:focus {
  -webkit-box-shadow: 0 0 0 1px rgb(122.8111587983, 132.3287553648, 140.7888412017);
          box-shadow: 0 0 0 1px rgb(122.8111587983, 132.3287553648, 140.7888412017);
  background: none;
  text-decoration: none;
}
...
.e-calendar .e-header .e-prev:hover > span, .e-calendar .e-header .e-next:hover > span {
  border: rgb(48.9202702703, 54.85, 60.7797297297);
  color: #fff;
  cursor: pointer;
}
.e-calendar .e-header .e-prev:hover, .e-calendar .e-header .e-next:hover {
