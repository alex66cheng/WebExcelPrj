...
.e-spreadsheet .e-comment-container {
  ...
  border: 1px solid rgba(var(--color-sf-surface-variant));
...
.e-spreadsheet.e-rtl .e-review-panel {
  -webkit-border-start: none;
          border-inline-start: none;
  -webkit-border-end: 1px solid rgba(var(--color-sf-outline-variant));
          border-inline-end: 1px solid rgba(var(--color-sf-outline-variant));
}
...
.e-spreadsheet.sf-spreadsheet .e-sheet-panel .back_content .vaxis {
  width: 0;
  border-right: rgba(var(--color-sf-surface-variant));
  border-style: solid;
  border-width: 0 1px 1px 0;
}
