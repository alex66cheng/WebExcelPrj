...
.e-spreadsheet .e-main-panel .e-ss-chart-overlay {
  border: 1px solid var(--color-sf-bg-tertiary);
}
...
.e-spreadsheet .e-comment-indicator::after {
  ...
  border-top: 4px solid var(--color-sf-brand-primary);
}
...
.e-spreadsheet .e-comment-body .e-comment-item .e-comment-edit-wrap .e-comment-edit-input.active {
  border-bottom: 2px solid rgb(15, 108, 189);
}
...
.e-spreadsheet.e-rtl .e-review-panel {
  -webkit-border-start: none;
          border-inline-start: none;
  -webkit-border-end: 1px solid rgb(224, 224, 224);
...
.e-spreadsheet.sf-spreadsheet .e-sheet-panel .back_content .vaxis {
  width: 0;
  border-right: var(--color-sf-border-secondary);
  border-style: solid;
  border-width: 0 1px 1px 0;
}
...
/*! spreadsheet theme */
.e-spreadsheet .e-findtool-dlg {
  border-color: var(--color-sf-border-secondary) var(--color-sf-border-secondary) var(--color-sf-border-secondary);
  -webkit-box-shadow: none;
          box-shadow: none;
}
...
.e-spreadsheet .e-sheet-panel:not(.e-rtl) .e-select-all-cell:hover .e-selectall:not(.e-highlight) {
  border-right-color: var(--color-sf-bg-secondary);
}
...
.e-spreadsheet .e-sheet-panel.e-rtl .e-selectall:hover {
  border-left-color: var(--color-sf-bg-secondary);
}
...
.e-spreadsheet .e-sheet-panel.e-rtl .e-cell.e-rcborderright {
  border-left: 1px dashed var(--color-sf-utility-danger);
}
...
.e-spreadsheet .e-sheet-panel .e-cell.e-rcborderbottom {
  border-bottom: 1px dashed var(--color-sf-utility-danger);
}
.e-spreadsheet .e-copy-indicator div.e-top,
.e-spreadsheet .e-range-indicator div.e-top,
.e-spreadsheet .e-formularef-indicator div.e-top {
...
.e-spreadsheet .e-selection {
  background-color: rgba(var(--color-sf-brand-primary), 0.12);
  border-color: var(--color-sf-brand-primary);
}
...
.e-spreadsheet .e-row-header .e-table tr.e-hide-end .e-header-cell.e-highlight::before {
  border-bottom-color: var(--color-sf-border-primary-alt);
}
...
.e-spreadsheet .e-row-header .e-table tr.e-hide-start .e-header-cell.e-highlight::after {
  border-top-color: var(--color-sf-border-primary-alt);
}
...
.e-spreadsheet .e-frozen-column {
  ...
  border-right: 3px solid var(--color-sf-border-secondary);
}
.e-spreadsheet .e-frozen-row {
  border-bottom: 3px solid var(--color-sf-border-secondary);
}
.e-spreadsheet .e-validation-list {
...
.e-spreadsheet .e-sheet-panel:not(.e-rtl) .e-cell.e-rcborderright {
  border-right: 1px dashed var(--color-sf-utility-danger);
}
...
.e-sort-dialog .e-sort-listwrapper {
  border-bottom: 1px dashed var(--color-sf-border-secondary);
}
.e-sort-dialog .e-sort-error {
