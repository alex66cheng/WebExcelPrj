...
.e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn .e-chart-icon, .e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn .e-chart-type-icon {
  font-size: 28px !important; /* stylelint-disable-line declaration-no-important */
  padding: 0 5px;
  width: 30px;
  margin-right: 5px;
}
...
.e-menu-container.e-border-selector .e-menu-item[id=borderColorPicker] {
  height: auto;
  line-height: calc(var(--e-radius) * 0);
  padding: calc(var(--e-radius) * 0);
}
...
.e-spreadsheet .e-sheet-tab-panel .e-btn.e-flat.e-icon-btn:disabled, .e-spreadsheet .e-sheet-tab-panel .e-btn.e-flat.e-icon-btn.e-disabled {
...
.e-spreadsheet .e-sheets-list:active .e-btn-icon, .e-spreadsheet .e-sheets-list.e-active .e-btn-icon, .e-spreadsheet .e-add-sheet-tab.e-flat:active .e-btn-icon, .e-spreadsheet .e-add-sheet-tab.e-flat.e-active .e-btn-icon {
  color: var(--color-sf-icon-color-pressed);
}
