...
.e-chart-menu.e-rtl .e-ul .e-menu-item .e-bar,
.e-chart-type-menu.e-rtl .e-ul .e-menu-item .e-bar {
  left: 0;
  right: -6px;
}
...
.e-spreadsheet .e-comment-container.e-thread-resolved:not(.active) .e-comment-body .e-list-item {
  background-color: #e0e0e0;
}
...
.e-spreadsheet .e-review-panel .e-review-wrap .e-review-body .e-pane-container.e-thread-resolved:not(.active) .e-comment-body .e-list-item {
  background-color: #e0e0e0;
}
