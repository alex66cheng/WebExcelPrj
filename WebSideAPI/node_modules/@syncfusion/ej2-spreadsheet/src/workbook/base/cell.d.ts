...
import { CellStyleModel, HyperlinkModel, ValidationModel, ChartModel, ExtendedWorkbook } from '../common/index';
import { ImageModel, ThreadedCommentModel, NoteModel } from '../common/index';
 ...
 */
export declare function wrap(address: string, wrap?: boolean, context?: ExtendedWorkbook, preventEvt?: boolean, isPublic?: boolean): void;
/**
 * @hidden
