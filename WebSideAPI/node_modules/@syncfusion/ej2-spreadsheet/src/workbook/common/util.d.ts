...
import { CellUpdateArgs, ExtendedThreadedCommentModel } from './index';
...
import { ExtendedNoteModel } from './index';
 ...
 * @hidden
 */
export declare function getUpdatedFormula(currIndexes: number[], prevIndexes: number[], sheet: SheetModel, context: Workbook, prevCell?: CellModel, isSort?: boolean, isValidation?: boolean): string;
/**
 ...
 * @hidden
 */
export declare function getSortedIndex(items: (ExtendedThreadedCommentModel | ExtendedNoteModel)[], address: number[], isComment: boolean): number;
/**
 ...
 * @hidden
 */
export declare function isReadOnlyCells(parent: Workbook, rangeIndexes?: number[], throwAlert?: boolean): boolean;
/**
