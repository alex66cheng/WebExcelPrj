...
export declare class Calculate extends Base<HTMLElement> implements INotifyPropertyChanged {
     ...
     */
    processLogical(stack: string[], operator: string, emptyStack?: string[]): string;
    /**
     * @hidden
    ...
    computeCountIfsFormulas(range: string[]): string | number;
    private getOperatorAndCriteria;
     ...
     */
    getANDComputedValue(condition: string): string;
     ...
     */
    getValueFromArg(val: string, isUnique?: boolean, isIfError?: boolean, isSubtotal?: boolean, isIFFormula?: boolean): string;
