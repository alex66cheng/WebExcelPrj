 ...
 * @hidden
 */
export declare function getUpdateUsingRaf(fn: Function, context?: Spreadsheet): void;
/**
 ...
 * @hidden
 */
export declare function disableSpreadsheetRaf(): void;
/**
 ...
 */
export declare function setRowEleHeight(parent: Spreadsheet, sheet: SheetModel, height: number, rowIdx: number, row?: HTMLElement, hRow?: HTMLElement, notifyRowHgtChange?: boolean, outsideViewport?: boolean, updateLineHeight?: boolean): void;
/**
 * @hidden
