...
.e-dialog .e-dlg-header-content {
  border-radius: calc(var(--e-radius) * 0.5) calc(var(--e-radius) * 0.5) calc(var(--e-radius) * 0) calc(var(--e-radius) * 0);
  line-height: 1.25;
}
...
.e-footer-content .e-btn.e-primary.e-flat:not([DISABLED]):not(.e-success):not(.e-danger):not(.e-warning):not(.e-info):focus-visible,
.e-footer-content .e-btn.e-primary.e-flat:not([DISABLED]):not(.e-success):not(.e-danger):not(.e-warning):not(.e-info):focus,
.e-footer-content .e-btn.e-primary.e-flat:not([DISABLED]):not(.e-success):not(.e-danger):not(.e-warning):not(.e-info):focus,
.e-footer-content .e-btn.e-flat:not([DISABLED]):not(.e-success):not(.e-danger):not(.e-warning):not(.e-info):focus-visible {
  background: rgba(var(--color-sf-primary), 0.08);
